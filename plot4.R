...
globalReactivePower <- as.numeric(df.subset$Global_reactive_power)
voltage <- as.numeric(df.subset$Voltage)
subMetering1 <- as.numeric(df.subset$Sub_metering_1)
subMetering2 <- as.numeric(df.subset$Sub_metering_2)
subMetering3 <- as.numeric(df.subset$Sub_metering_3)
